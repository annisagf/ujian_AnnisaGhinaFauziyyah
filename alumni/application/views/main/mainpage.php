		...
		<div class="title">
			<span class="subtitle  white-text">
				<h2 data-aos="fade-down"><strong>Hogwarts School of Witchcraft and Wizardry</strong></h2>
			</span><br>
			<br>
			<?php echo anchor('#testimoni', 'testimoni', 'class="waves-effect waves-light btn-large orange lighten-2" data-aos="fade-left"'); ?>
		</div>
		<div class="container">
			<div class="row">
				<a id="testimoni" class="line">
					<h4 class="margin h1" data-aos="zoom-out" data-aos-duration="500">Testimoni Alumni</h4>
					<?php echo anchor('auth/login', 'Isi Testimoni', 'class="waves-effect waves-light btn-large grey darken-1" data-aos="fade-right"'); ?>
