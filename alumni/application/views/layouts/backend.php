...
<head>
	...
	<title>Hogwarts School | Home</title>
...
<body class="theme-teal">
	...
	<nav class="navbar">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="home">Hogwarts School</a>
			</div>
	...
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				<div class="image">
					<img src="<?php echo base_url('assets/backend'); ?>/images/heri.jpg" width="50" height="60" alt="User" />
				</div>
			...
			<div class="legal">
				<div class="copyright">
					&copy; <?php echo date('Y'); ?> <a href="javascript:void(0);">Annisa Ghina Fauziyyah</a>.
				</div>
				<div class="version">
